...
class gsp_shouldIorV1_authenticationseedLogin_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/authentication/seedLogin.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(37)
invokeTag('actionSubmit','g',114,['value':("Login"),'onclick':("return validate()"),'type':("submit"),'action':("loginSeedAccount"),'style':("margin-top: 5px; width: 100%; "),'class':("btn btn-primary")],-1)
printHtmlPart(1)
})
invokeTag('form','g',115,['controller':("Authentication"),'action':("loginSeedAccount"),'enctype':("multipart/form-data"),'class':("form-signin"),'style':("max-width: 300px; margin: auto;")],2)
printHtmlPart(38)
...
invokeTag('captureBody','sitemesh',199,['style':("background-color: #F6F6F6!important; background-image:url('${resource(dir: "images", file: "wall1.jpg")}'); margin-bottom: 20px; background-size: cover;  background-attachment: fixed; min-width: 320px;  ")],1)
printHtmlPart(44)
}
...
public static final long LAST_MODIFIED = 1444690376161L
