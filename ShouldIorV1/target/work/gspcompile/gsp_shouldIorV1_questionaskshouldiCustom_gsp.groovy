...
createTagBody(2, {->
printHtmlPart(42)
for( _it326102242 in (categories) ) {
changeItVariable(_it326102242)
printHtmlPart(43)
...
expressionOut.print(createLink(controller: 'ShouldI', action: 'help'))
printHtmlPart(47)
invokeTag('actionSubmit','g',215,['onclick':("return validate()"),'value':("Post"),'action':("postShouldICutom"),'style':("margin-top: 1px; width: 100px; display: inline-block;"),'class':("btn btn-default")],-1)
printHtmlPart(48)
})
invokeTag('form','g',216,['controller':("Question"),'action':("postShouldICutom"),'enctype':("multipart/form-data")],2)
printHtmlPart(49)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginFaceBook'))
printHtmlPart(50)
...
invokeTag('captureBody','sitemesh',532,['style':("background-color: #f4f4f4; min-width: 330px; ")],1)
printHtmlPart(55)
}
...
public static final long LAST_MODIFIED = 1444775802289L
