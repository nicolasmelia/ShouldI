...
printHtmlPart(11)
invokeTag('javascript','g',28,['src':("dataRequest.js")],-1)
printHtmlPart(12)
...
createTagBody(2, {->
printHtmlPart(43)
for( _it38840646 in (categories) ) {
changeItVariable(_it38840646)
printHtmlPart(44)
...
expressionOut.print(createLink(controller: 'ShouldI', action: 'help'))
printHtmlPart(48)
invokeTag('actionSubmit','g',269,['onclick':("return validate()"),'value':("Post"),'action':("postShouldICutom"),'style':("margin-top: 1px; width: 100px; display: inline-block;"),'class':("btn btn-default")],-1)
printHtmlPart(49)
})
invokeTag('form','g',271,['controller':("Question"),'action':("postShouldICutom"),'enctype':("multipart/form-data")],2)
printHtmlPart(50)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginFaceBook'))
printHtmlPart(51)
...
printHtmlPart(55)
invokeTag('resource','g',337,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput-angular.js")],-1)
printHtmlPart(56)
invokeTag('resource','g',338,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.js")],-1)
printHtmlPart(57)
...
public static final long LAST_MODIFIED = 1444348265790L
