...
class gsp_shouldIorV1_categoryaddCategory_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/category/addCategory.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(37)
invokeTag('actionSubmit','g',140,['value':("Add"),'action':("createCategory"),'style':("margin-top: 1px; width: 100px; display: inline-block;"),'class':("btn btn-default")],-1)
printHtmlPart(38)
})
invokeTag('form','g',142,['controller':("Category"),'action':("updateMotd"),'enctype':("multipart/form-data")],2)
printHtmlPart(39)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginFaceBook'))
printHtmlPart(40)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginReddit'))
printHtmlPart(41)
invokeTag('resource','g',186,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput-angular.js")],-1)
printHtmlPart(42)
invokeTag('resource','g',187,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.js")],-1)
printHtmlPart(43)
invokeTag('resource','g',188,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.css")],-1)
printHtmlPart(44)
})
invokeTag('captureBody','sitemesh',329,['style':("background-color: #f4f4f4; min-width: 330px; ")],1)
printHtmlPart(45)
}
...
public static final long LAST_MODIFIED = 1443459548506L
