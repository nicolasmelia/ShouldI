...
printHtmlPart(45)
invokeTag('actionSubmit','g',197,['value':("Update"),'onclick':("return validate()"),'action':("updateProfile"),'style':("margin-top: 1px; width: 100px; display: inline-block;"),'class':("btn btn-default")],-1)
printHtmlPart(46)
})
invokeTag('form','g',204,['controller':("User"),'action':("updateProfile"),'enctype':("multipart/form-data")],2)
printHtmlPart(47)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginFaceBook'))
printHtmlPart(48)
expressionOut.print(createLink(controller: 'Authentication', action: 'loginReddit'))
printHtmlPart(49)
invokeTag('resource','g',244,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput-angular.js")],-1)
printHtmlPart(50)
invokeTag('resource','g',245,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.js")],-1)
printHtmlPart(51)
invokeTag('resource','g',246,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.css")],-1)
printHtmlPart(52)
})
...
public static final long LAST_MODIFIED = 1444409388345L
