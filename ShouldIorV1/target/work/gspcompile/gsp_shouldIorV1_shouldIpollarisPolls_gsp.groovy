...
class gsp_shouldIorV1_shouldIpollarisPolls_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/shouldI/pollarisPolls.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(45)
invokeTag('resource','g',175,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput-angular.js")],-1)
printHtmlPart(46)
invokeTag('resource','g',176,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.js")],-1)
printHtmlPart(47)
invokeTag('resource','g',177,['dir':("js/tagsJS"),'file':("bootstrap-tagsinput.css")],-1)
printHtmlPart(48)
})
invokeTag('captureBody','sitemesh',212,['style':("background-color: #f4f4f4; min-width: 330px; margin-bottom: 15px; ")],1)
printHtmlPart(49)
}
...
public static final long LAST_MODIFIED = 1444594394375L
