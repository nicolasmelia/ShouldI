...
printHtmlPart(12)
invokeTag('resource','g',32,['dir':("js/typeaheadJS"),'file':("typeahead.jquery.min.js")],-1)
printHtmlPart(12)
invokeTag('resource','g',35,['dir':("js/chart"),'file':("Chart.min.js")],-1)
printHtmlPart(13)
})
...
invokeTag('captureBody','sitemesh',269,['style':(" background-color: #f5f8fa!important; min-width: 320px; min-height: 100%; margin-bottom: 15px;  ")],1)
printHtmlPart(64)
}
