...
<html lang="en">
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" >
    ...
    <div class="container">
      ...
      <g:form controller="Authentication" action="loginSeedAccount" enctype="multipart/form-data" class="form-signin" style = "max-width: 300px; margin: auto;">
        
        
        <h2 class="form-signin-heading" style = "color: #FFFFFF;  text-shadow: 2px 2px #5e5e5e; "><span class = "fa fa-unlock-alt"></span> Seed account login</h2>
       

       
        <label for="inputEmail" class="sr-only"  >Enter a new or existing username</label>
        <input id = "username"  name = "username" type="text" id="inputEmail" class="form-control" placeholder="Username" required autofocus>
        <g:actionSubmit value = "Login"   onclick="return validate()"   type="submit" action = "loginSeedAccount" style = "margin-top: 5px; width: 100%; "  class="btn btn-primary"/>
      </g:form>
            ...
            <div class="modal-dialog">
               ...
               <div class="modal-content">
                  <div class="modal-header">
                     <h4 class="modal-title"><span href="#about" style = "padding-left: 4px;" class='fa fa-hourglass'> </span> Logging you in <b>SEED</b> account...</h4>
                  </div>
