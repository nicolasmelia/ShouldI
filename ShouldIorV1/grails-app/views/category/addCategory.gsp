...
<html lang="en">
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" >
	...
	<div class="form-group" style = "padding-left: 16px;  display:block; padding-right: 16px; padding-top: 1px; ">		
	 ...
	 <g:form controller="Category" action="updateMotd" enctype="multipart/form-data" >
	<input id = 'title' type="text" name = "category" style = "width: 100%;  margin-top: 8px; " class="form-control"  placeholder="Category">



	<div style = "display: block; width: 100%" >
	<g:actionSubmit value = "Add"  action = "createCategory" style = "margin-top: 1px; width: 100px; display: inline-block;" class="btn btn-default"/>
	</div>
			</g:form>
