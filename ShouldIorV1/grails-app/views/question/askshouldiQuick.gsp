  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" >
      ...
      <div class="container" style = "max-width: 725px; margin-bottom: 15px; ">
         <div style = "width: 100%; margin-top: 70px; margin-bottom: 8px;   ">
            ...
            <div  id = "trendingSelect" onClick = "showNoLoginQuest()" class = "flatMenuItem"   style= " margin-left: 5px; display:inline-block;  border-bottom: 2px solid #cbe7ff; ">
               <span   class = "flatMenuItemText"  style = " font-size: 17px;" >Yes/No</span>
            </div>
            <div  id = "recentSelect"  onClick = "showNoLoginQuest()" class = "flatMenuItem" style= " margin-left: 5px; display:inline-block; border-bottom: 2px solid #cbe7ff; " >
               <span   class = "flatMenuItemText"  style = " font-size: 17px;" >Custom</span>
            </div>
