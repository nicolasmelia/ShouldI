...
<html lang="en">
   <head>
      ...
      <!-- Share image -->
      <meta property="og:image" content="http://shouldiBeta.elasticbeanstalk.com/Question/getShareImageById/${question.questionID}"/>
      </g:if>
   ...
   <body style = "background-color: #f5f8fa!important; margin-bottom: 20px;  ">
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top" >
      ...
      <div  class="contentContainer">
         ...
         <div style ="display: block; width: 100%; padding-bottom: -5px; " >
            ...
            <div  style="display: block;  padding: 10px;  border-bottom: solid 1px; border-color: #f3f3f3;  margin: auto;  ">
               ...
               <g:if test="${question.anonymous == false && question.UserID != 'nonUser' && question.privateQuestion == false}">
				...
				<g:elseif test="${question.UserID == 'nonUser' || question.privateQuestion == true}"> 
               <div style = 'text-align: center; width: 100%; text-align: center;	color: #33A6DD; padding-top: 5px;  font-size: 24px;'>
                  <span class = "fa  fa-line-chart"></span> Private Poll 
               </div> 
               
                              <div style = 'text-align: center; width: 100%; text-align: center; color: #33A6DD;  font-size: 14px;'>
                   Share this pages <a onClick = "displayPageLink()" style = "cursor: default;"><b>link</b></a></br>
                    <span id = "pageLink" style = "display: none; font-size: 14px; color: #8D8D8D; word-break: break-all;"><u>www.ShouldI.fm/question/shouldi/${question.questionID}</u></span>                                               
				       </div>          
            ...
            <div style = " display: block; height: 50px;  ">
               ...
               <g:else>
                  <div style = "margin: 0px; text-align: center;  padding: 0px; width: 100%;" id = "questionText">
                     ${raw(question.question)}	    
                  </div>   
               </g:else>
         ...
         <div style = "width: 100%; ">
            <div  class="contentContainer">
               ...
               <div class = "scrollCon" style = 'overflow-x: hidden;'>
                  <div  class="row" style = "cursor: default; ">          
                  <g:each in="${questionPromo1}">
                     <div style = "overflow: hidden; text-align: center; height: 120px; " onmouseover="glow(this)" onmouseout="unGlow(this)"  onClick = "loadQuestionURL('${createLink(controller: 'Question', action: 'shouldi', params: [id: it.questionID])}')"  class="col-xs-6 col-sm-3 col-md-3">
                           <table style = "width: 100%; height: 100%; min-height: 120px; ">
                              <tr style = "width: 100%;">
                                 <td style = "vertical-align:middle; margin: auto;" >                                 
                                    <g:if test="${it.answerOneImage}">
                                       <img style = " vertical-align:middle; padding: 3px; margin: auto; " class = "bigViewImg"  src = "${createLink(controller: 'Question', action: 'getAnswerImageById', params: [id: it.questionID, imgNum: '1', thumb: 'True'])}"  />	
                                    </g:if>
                                    <g:else>
                              ...
                              <tr>
                                 <td valign="middle">
                                    <div style = "display: block; margin-top: 0px;" >
                                       <div  style = "padding: 0px; bottom: 0px; right: 0; left: 0; margin: auto; font-size: 13px;" class = "questionTitle" >${it.questionTitle}</div>
                                    </div> 
                                 </td>
                              </tr>
                           </table>
         ...
         <!-- COMMENT BOX -->	
         <div  class="contentContainer">
            <div class="fb-comments" data-href="http://www.shouldi.fm/question/shouldi/${questionID}"  data-colorscheme="light" data-numposts="5"></div>
         </div>
         <!-- COMMENT BOX -->
      ...
      <script>
         ...
         imgLink = "http://shouldiBeta.elasticbeanstalk.com/Question/getShareImageById/" + questionID;
         } else {
         // Nothing for now
         }
