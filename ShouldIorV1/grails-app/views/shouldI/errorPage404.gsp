 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" >
	...
	<!-- Question form -->	
		<div  class="jumbotron" style="overflow: none;  display: block; box-shadow:0 0 10px rgba(0, 0, 0, 0.15); min-height: 100px; margin: auto; min-width: 200px; margin-top: 65px;  max-width: 755px; padding: 8px; margin-bottom: 20px; background-color: #FDFDFD;  ">
			<h2  style = "color: #6f6f6f; width: 100%; text-align: center; margin: auto; padding: 15px; "><b>404:</b> Something went wrong...</h2>
			<div>
			
			<div class = "well" style = "display: block; width: 98%; margin: auto;">
				<span style = "color: #337ab7"><b>www.shouldi.fm -</b> We're sorry but you may be lost... or there was a problem on our end! Try again by pressing the home button.  </span> <br>
				<img style = "width:50%; vertical-align: top;  display:  block;  margin: auto;  padding:10px; min-width: 250px; " src="${resource(dir:'images',file:'sad.png')}"   />				
			     <button  onClick = "loadURL('${createLink(controller: 'ShouldI', action: 'home')}')" style = "width: 100%;" type="button" class="btn btn-default"> <span class = "fa fa-home"></span> Take Me Home</button>
